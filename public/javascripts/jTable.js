...
(function($) {
  ...
  return $.fn.jTable = function(options) {
    ...
    return this.each(function() {
      var addSearch, buildTable, buildTableHead, changePage, column, fetchItems, generateBaseQuery, i, updateItems, updatePagination, updateTableRows, _len, _ref;
      ...
      buildTable = __bind(function() {
        this.container.html('<table><thead><tr><th></th></tr></thead><tbody></tbody></table>');
      ...
      buildTableHead = __bind(function() {
        ...
        if (this.settings.editLink || this.settings.destroyLink) {
          return table_head.append($("<th></th>"));
        }
      }, this);
